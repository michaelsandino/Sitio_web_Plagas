...
include("../../connect.php");
    ...
    if ($user_rol == 'Admi') {
        ...
        $consult="SELECT * FROM solicitud_proyecto s, cultivo c, usuarioapp u WHERE s.id_cultivofk = c.idCultivo AND c.idUsuCultivo= u.email AND c.idUsuCultivo!='$user_email' AND s.stado_sp='$estado' ORDER BY s.fech_ini ASC";  
            ...
            while($view = mysqli_fetch_array($result)){
                ...
                if ($check1 or $check2 or $check3) {
                    ...
                    while($info = mysqli_fetch_array($information)){
                        ...
                        <br><img src="../../icons/ecologico.svg" class="pr-1"  alt="icono_usuario" height="20px"> '.$info['nameRegional'].'</br></p> 
                        <hr>
